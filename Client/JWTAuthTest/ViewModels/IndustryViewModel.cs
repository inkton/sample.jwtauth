...
namespace Jwtauth.ViewModels
{
    public class IndustryViewModel : ViewModel<Trader>
    {
        ...
        public static IndustryViewModel Current;
        ...
        public static void Init(BackendService<Trader> backend)
        {
            Current = new IndustryViewModel(backend);
        }
            ...
            : base(backend)
        {
            ...
            OpenWebCommand = new Command(() => Device.OpenUri(new Uri("https://nestyt.com/blog/")));
        }
        ...
        public AuthViewModel<Trader> AuthViewModel
        {
            get
            {
                ...
                {
                    _authViewModel = new AuthViewModel<Trader>(_backend);
                }
